# Threadline Wargame - Event Runbook (6-7 hour session)
...
|---|---|---|---|
| T+0:00 | Kickoff + briefing | `threadline-00-start-here` | Rules, legal/PAI boundary, tool check (Maps/reverse-image/EXIF/w3w/FIRMS/MarineTraffic/Wayback/CyberChef). Everyone solves start-here. |
...
- **Hint economy:** Threadline is not wallet-managed; give verbal tiered nudges
