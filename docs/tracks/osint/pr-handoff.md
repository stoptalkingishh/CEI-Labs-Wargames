...
- **Where the track is now:** `main` runs a small, neutral **plugin-based OSINT
  ...
  `docs/tracks/osint/README.md` and the pilot entries in `CHANGELOG.md`.
...
- **Where the earlier work went:** `docs/tracks/osint/archive/` — `legacy-idea-bank.json`
...
| Pilot docs & state | `docs/tracks/osint/README.md` |
| Generated CTFd import YAML (git-ignored) | `osint/*/challenge.yml` |
| Retired 42-lead skill ideas | `docs/tracks/osint/archive/legacy-idea-bank.json` |
| Retired campaign: OCR'd briefings | `docs/tracks/osint/archive/briefing-transcripts.json` |
| Retired campaign: player quickstart | `docs/tracks/osint/archive/participant-quickstart.md` |
| Retired campaign: release verification | `docs/tracks/osint/archive/release-verification.md` |
