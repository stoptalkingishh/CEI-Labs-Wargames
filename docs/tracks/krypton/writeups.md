...
tr '[:alpha:]' 'N-ZA-Mn-za-m' < /home/krypton1/krypton2
```
**Result:** `ROTTEN`
...
**Goal:** `/home/krypton2/krypton3` is Caesar-shifted by an amount
...
/home/krypton2/encrypt < plain.txt
```
...
`krypton3`:
```
krypton-tools rotate -13 /home/krypton2/krypton3    # example for shift 13; adjust to match what was actually observed
```
**Result:** `CAESARISEASY`
...
**Goal:** `/home/krypton3/krypton4` is a monoalphabetic substitution
cipher. Three extra intercepted files (`found1`–`found3`) use the same
key.
```
ssh krypton3@<host> -p <port>    # password: CAESARISEASY
krypton-tools freq /home/krypton3/found1 /home/krypton3/found2 \
  /home/krypton3/found3 /home/krypton3/krypton4
```
...
**Goal:** `/home/krypton4/krypton5` is Vigenère-encrypted with a
known 6-letter key.
```
ssh krypton4@<host> -p <port>    # password: BRUTE
krypton-tools columns 6 /home/krypton4/krypton5
```
...
```python
ct = ''.join(c for c in open('/home/krypton4/krypton5').read() if c.isalpha())
...
`/home/krypton6/final` to recover the final plaintext.
