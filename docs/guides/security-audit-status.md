...
**Related:** [`cei-labs-net` status](https://github.com/stoptalkingishh/cei-labs-net/blob/main/docs/guides/security-audit-status.md) · [`cei-labs-engine` status](https://github.com/stoptalkingishh/cei-labs-engine/blob/main/docs/guides/security-audit-status.md)
...
`docs/guides/challenge-inventory.md`'s finding). It now has a real `krypton0`
