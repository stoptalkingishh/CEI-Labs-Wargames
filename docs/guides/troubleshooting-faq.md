...
- `cei-labs-engine/docs/guides/self-hosted-wargames-status.md`
- `CEI-Labs-Wargames/docs/guides/self-hosted-wargames-status.md`
...
actually shared" in `cei-labs-engine/docs/guides/self-hosted-wargames-status.md`.
...
`CEI-Labs-Wargames/docs/tracks/bandit/writeups.md`), so it's worth
