...
**Related:** [`cei-labs-engine` status](https://github.com/stoptalkingishh/cei-labs-engine/blob/main/docs/guides/self-hosted-wargames-status.md) · [`cei-labs-net` status](https://github.com/stoptalkingishh/cei-labs-net/blob/main/docs/guides/self-hosted-wargames-status.md) · full working checklist: `docs/guides/self-hosted-wargames-blueprint.md`
