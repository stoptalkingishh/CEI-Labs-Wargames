...
`docs/guides/instructor-cheatsheet.md` (level-by-level help) and
`docs/guides/troubleshooting-faq.md` (known quirks, cross-linked from here
...
2. **Create participant accounts** (or open registration) ahead of time
   ...
   (see `docs/guides/troubleshooting-faq.md`) — relevant if you're scripting
...
3. **Decide your release pace.** Track-level release-gating (letting you
   ...
   `docs/guides/wargame-building-playbook.md`. Until it exists, all three
...
4. **Print or pull up** `docs/guides/instructor-cheatsheet.md` — that's your
...
`docs/guides/troubleshooting-faq.md` and the underlying status docs it links
to:
...
- If you hit anything not covered above, add it to
  `docs/guides/troubleshooting-faq.md` so the next event benefits — this
