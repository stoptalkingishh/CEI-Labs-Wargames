...
```bash
grep -rEo "https?://[^ )\"']+" docs/guides/participant-quickstart.md docs/guides/troubleshooting-faq.md challenges/*/challenge.yml
```

- `docs/guides/participant-quickstart.md` and `docs/guides/troubleshooting-faq.md`:
...
inventory in [`docs/guides/network-access.md`](network-access.md) (that doc's
...
- **Docs/hints:** `docs/guides/participant-quickstart.md` and
  `docs/guides/troubleshooting-faq.md` link nowhere; challenge hint links are
  the same five domains already tracked in `docs/guides/network-access.md`,
