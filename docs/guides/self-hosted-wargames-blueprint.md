...
[`docs/guides/self-hosted-wargames-status.md`](self-hosted-wargames-status.md)
...
this catalog was built to provide (see docs/guides/security-audit-status.md and
docs/guides/challenge-inventory.md's own finding on this). `krypton-00` now has
