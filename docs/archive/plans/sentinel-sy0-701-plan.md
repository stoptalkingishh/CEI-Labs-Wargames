...
| Documentation | Add `docs/tracks/sentinel/{writeups,learning-objectives,cheatsheet}.md` and update the README, curriculum index, facilitator material, participant quick-start, and inventory. |
