#!/usr/bin/env python3
"""Generate the Threadline wargame (a full 6-7 hour OSINT campaign).
...
this generator writes to the git-ignored `threadline/` directory instead).
...
`CEI_AGENT_RELEASE_STATE=visible`); release with
...
def _briefing_html(ch):
    ...
    overlay = (
        ...
        '         <span style="color:#8c6d2f;font-size:.75rem;letter-spacing:.12em;text-transform:uppercase">OSINT Directorate // Threadline</span>'
        '       </div>'
        ...
        + 'THREADLINE // ' + label + ' // CASE FILE</div>'
        '   </div>'
...
_TRANSCRIPT_FILE = _Path(__file__).resolve().parent.parent / "docs" / "threadline" / "briefing-transcripts.json"
...
F.append(mk(
    ...
    "threadline-01-cartel-airdrop", "Cartel Air-Drop Lane", 100,
...
F.append(mk(
    ...
    "FM IPB/ground-truth",
    "threadline-02-cartel-safehouse", "Cartel Safehouse", 100,
...
F.append(mk(
    ...
    "threadline-03-cartel-precursor", "Precursor Source", 100,
...
F.append(mk(
    ...
    "threadline-04-cartel-meet", "The Strange File", 100,
...
F.append(mk(
    ...
    "threadline-05-synd-exfil", "Exfil on the Wire", 120,
...
F.append(mk(
    ...
    "threadline-06-synd-intercept", "Intercepted Meeting", 120,
...
F.append(mk(
    ...
    "threadline-07-synd-beacon", "Emergency Beacon", 120,
...
F.append(mk(
    ...
    "ATP discovery/collection, FM intelligence-cycle",
    "threadline-08-synd-burn", "The Burn Laptop", 130,
...
F.append(mk(
    ...
    "threadline-09-synd-wallet", "The Wallet Ledger", 130,
...
F.append(mk(
    ...
    "threadline-10-synd-deaddrop", "Dead-Drop Slip", 100,
...
F.append(mk(
    ...
    "FM target-acq, IMINT",
    "threadline-11-gen-tank", "The Stolen AFV", 140,
...
F.append(mk(
    ...
    "threadline-12-gen-frigate", "Sold Frigate Plans", 140,
...
F.append(mk(
    ...
    "threadline-13-gen-airfield", "The Safe Airfield", 140,
...
F.append(mk(
    ...
    "threadline-14-gen-aircraft", "The Decommissioned 747", 150,
...
F.append(mk(
    ...
    "threadline-15-chan-strike", "The Strike Window", 150,
...
F.append(mk(
    ...
    "threadline-16-chan-ao", "The Quiet AO", 150,
...
F.append(mk(
    ...
    "ATP capture/authenticate, ATP discovery",
    "threadline-17-chan-smuggle", "The Sanctioned Road", 150,
...
F.append(mk(
    ...
    "threadline-18-chan-fleet", "The Flagged Corridor", 180,
...
F.append(mk(
    ...
    "threadline-19-chan-manifest", "The Decoy Manifest", 130,
...
F.append(mk(
    ...
    "threadline-20-chan-cover", "The Approved Trade", 150,
...
F.append(mk(
    ...
    "threadline-21-hades-operative", "The Gifted Jacket", 140,
...
F.append(mk(
    ...
    "threadline-22-hades-cutout", "The Hades Cutout", 150,
...
F.append(mk(
    ...
    "threadline-23-hades-payment", "Payment on the Corner", 150,
...
F.append(mk(
    ...
    "ATP capture/authenticate",
    "threadline-24-hades-hostage", "The Hostage Note", 160,
...
F.append(mk(
    ...
    "FM IPB/ground-truth",
    "threadline-25-hades-hit", "Dead Man's Park", 140,
...
F.append(mk(
    ...
    "FM spatial/IPB, FM target-acq",
    "threadline-26-hades-slayer", "Four Points to an Address", 180,
...
F.append(mk(
    ...
    "FM IPB/ground-truth, FM target-acq",
    "threadline-27-ash-strike", "Grid-Strike Plot", 160,
...
F.append(mk(
    ...
    "threadline-28-ash-distress", "Morse on the Dead Network", 140,
...
F.append(mk(
    ...
    "threadline-29-ash-freelancer", "The Financed Freelancer", 160,
...
F.append(mk(
    ...
    "threadline-30-cult-funnel", "The Believers' Ledger", 140,
...
F.append(mk(
    ...
    "FM collection-mgmt, reliability/corroboration",
    "threadline-31-cult-origin", "Origin Myth", 140,
...
F.append(mk(
    ...
    "threadline-32-cult-signal", "The Signal Site", 150,
...
F.append(mk(
    ...
    "ATP capture/authenticate",
    "threadline-33-cult-cipher", "The Cult Cipher", 140,
...
F.append(mk(
    ...
    "FM IPB/ground-truth",
    "threadline-34-cult-caravan", "The Traveling Saint", 140,
...
F.append(mk(
    ...
    "threadline-35-cult-ledger", "The Tithing Ledger", 140,
...
F.append(mk(
    ...
    "FM IPB/ground-truth, temporality",
    "threadline-36-cult-prophecy", "The Prophecy Site", 150,
...
F.append(mk(
    ...
    "ATP discovery/collection, OPSEC",
    "threadline-37-cult-relic", "Relic Video", 100,
...
F.append(mk(
    ...
    "threadline-38-cult-money", "The Money Pass", 150,
...
F.append(mk(
    ...
    "FM IPB/ground-truth",
    "threadline-39-cult-cache", "Relic Cache", 130,
...
F.append(mk(
    ...
    "threadline-40-loom-corroborate", "Source Discipline", 190,
...
F.append(mk(
    ...
    "threadline-41-loom-assess", "Who Weaves the Loom?", 250,
...
FLAGS = {
    "threadline-00-start-here": "WELCOME TO THREADLINE",
    "threadline-01-cartel-airdrop": "spain-cambados-aldea-o-facho",
    "threadline-02-cartel-safehouse": "calle-106-riomar-barranquilla-atlantico-colombia",
    "threadline-03-cartel-precursor": "cover-company-source",
    "threadline-04-cartel-meet": "libya-nalut-dirj-47-definitive-doorpost-thickness-car-wash",
    "threadline-05-synd-exfil": "https://pastebin.com/raw/U7zb8Kyh",
    "threadline-06-synd-intercept": "sheraton-hotel-zagreb-31-03-2023-1300",
    "threadline-07-synd-beacon": "-1.251946,-78.370167,19",
    "threadline-08-synd-burn": "FLAG{copycatkitty}",
    "threadline-09-synd-wallet": "SoFi-Stadium-33.953417,-118.338863,18",
    "threadline-10-synd-deaddrop": "https://bit.ly/3Dq6rGW",
    "threadline-11-gen-tank": "israel-merkava-mk-4m",
    "threadline-12-gen-frigate": "type-054a-jiangkai-II",
    "threadline-13-gen-airfield": "syria-latakia-jableh-khmeimim-air-base",
    "threadline-14-gen-aircraft": "canada-essa-sweden",
    "threadline-15-chan-strike": "jaisalmer-amritsar-naliya-tuesday-2000-imran-hameed",
    "threadline-16-chan-ao": "village-d-enfants-sos-khouloum-kayes",
    "threadline-17-chan-smuggle": "20.899370,95.118041,16",
    "threadline-18-chan-fleet": "guria_9758351_abidjan.ivory.coast_mindelo.cape.verde_las.palmas.spain_manzanillo.panama_posorja.ecuador",
    "threadline-19-chan-manifest": "44.470394,32.264429",
    "threadline-20-chan-cover": "castello-di-brescia",
    "threadline-21-hades-operative": "latanya-hotel-ankara-+903124168800",
    "threadline-22-hades-cutout": "serbia-rakinac-44.259654-21.057843",
    "threadline-23-hades-payment": "continuation.partakes.devolved",
    "threadline-24-hades-hostage": "inched.barman.fast",
    "threadline-25-hades-hit": "cedar-rose-park-ohlone-greenway",
    "threadline-26-hades-slayer": "forum.report.rent",
    "threadline-27-ash-strike": "Antonivka-Khersonska-Kindijska-35-6",
    "threadline-28-ash-distress": "omega.expendable.ridge",
    "threadline-29-ash-freelancer": "Evgenil_Kuznetsova_11_Kestrel_Drive",
    "threadline-30-cult-funnel": "https://nuforc.org/sighting/?id=175200",
    "threadline-31-cult-origin": "https://www.thecryptocrew.com/2014/06/driver-has-close-sighting-of-bigfoot.html",
    "threadline-32-cult-signal": "37455327-79981241-catawba-rd",
    "threadline-33-cult-cipher": "klumgongyn-credential",
    "threadline-34-cult-caravan": "maldives-elhe-didi-magu",
    "threadline-35-cult-ledger": "gaius-suetonius-tranquillus-de-vita-caesarum",
    "threadline-36-cult-prophecy": "amber-palace-sam-sing-kung-temple-1930",
    "threadline-37-cult-relic": "fh453n3fk45b384gm$&%#fjksdfmo94853ff",
    "threadline-38-cult-money": "D94KF932409KGL09324",
    "threadline-39-cult-cache": "0525-Elburg-punk-runways-messed",
    "threadline-40-loom-corroborate": "corrob-two-sources",
    "threadline-41-loom-assess": "the-loom-assess-product",
}
...
CHALLENGE_SOURCE_ZIP = {
    "threadline-01-cartel-airdrop": "florida-snow.zip",
    "threadline-02-cartel-safehouse": "the-cartel-connection.zip",
    "threadline-03-cartel-precursor": "gas-attack.zip",
    "threadline-04-cartel-meet": "a-strange-file.zip",
    "threadline-05-synd-exfil": "on-the-wire.zip",
    "threadline-06-synd-intercept": "operation-wiretap.zip",
    "threadline-07-synd-beacon": "emergency-transmission.zip",
    "threadline-08-synd-burn": "the-copycat-killer.zip",
    "threadline-09-synd-wallet": "the-sleeper-cell.zip",
    "threadline-10-synd-deaddrop": "dialogues-from-atlantis.zip",
    "threadline-11-gen-tank": "friendly-fire.zip",
    "threadline-12-gen-frigate": "naval-intrusion.zip",
    "threadline-13-gen-airfield": "cold-war-enemies.zip",
    "threadline-14-gen-aircraft": "last-flight.zip",
    "threadline-15-chan-strike": "line-of-control.zip",
    "threadline-16-chan-ao": "prisoner-of-war.zip",
    "threadline-17-chan-smuggle": "road-to-nowhere.zip",
    "threadline-18-chan-fleet": "undercover_fleet.zip",
    "threadline-19-chan-manifest": "lost-at-sea.zip",
    "threadline-20-chan-cover": "the-road-to-rome.zip",
    "threadline-21-hades-operative": "operation-bloodhound.zip",
    "threadline-22-hades-cutout": "rogue-agent.zip",
    "threadline-23-hades-payment": "echoes-of-retaliation.zip",
    "threadline-24-hades-hostage": "kidnapped.zip",
    "threadline-25-hades-hit": "the-killer-clown.zip",
    "threadline-26-hades-slayer": "the-midnight-slayer.zip",
    "threadline-27-ash-strike": "substation-bombing.zip",
    "threadline-28-ash-distress": "saving-isabella.zip",
    "threadline-29-ash-freelancer": "the-russian-blackmailer.zip",
    "threadline-30-cult-funnel": "alien-abduction.zip",
    "threadline-31-cult-origin": "chasing-bigfoot.zip",
    "threadline-32-cult-signal": "appalachian-aliens.zip",
    "threadline-33-cult-cipher": "klumgongyn-returns.zip",
    "threadline-34-cult-caravan": "wheres-klumgongyn.zip",
    "threadline-35-cult-ledger": "return-of-the-krohndahkyr.zip",
    "threadline-36-cult-prophecy": "lost-in-time.zip",
    "threadline-37-cult-relic": "nightmare-fuel.zip",
    "threadline-38-cult-money": "peepeekun.zip",
    "threadline-39-cult-cache": "kanonniers.zip",
    # osint-40/41 are capstones with no single source zip
}

# --- hints (subset; OSINT is not wallet-managed, but author for future) ------
HINTS = {
    "threadline-01-cartel-airdrop": [
...
def main_build():
    ...
    for ch in CHALLENGES:
        ...
        yaml = f"""name: "{ch['name']}"
author: "CEI Labs (wargame: Threadline)"
category: "OSINT"
description: |
  {full_desc}
value: {ch["points"]}
...
"""
    ...
    (BASE_DIR / "threadline-training.json").write_text(json.dumps(manifest, indent=2, sort_keys=True) + "\n", encoding="utf-8")
    if wallet:
        (BASE_DIR / "threadline-hint-wallet.json").write_text(json.dumps({"schema_version": 1, "track": "threadline", "entries": wallet}, indent=2, sort_keys=True) + "\n", encoding="utf-8")

    print(f"Generated {len(CHALLENGES)} Threadline challenges into '{BASE_DIR}' (state={RELEASE_STATE}).")
    print("Release with:   THREADLINE_RELEASE_STATE=visible python3 scripts/build_threadline.py")
