...
HINTS = {
    ...
    "krypton-01": [
        ...
        "Log in as `krypton1`, then `tr '[:alpha:]' 'N-ZA-Mn-za-m' < /krypton/krypton1/krypton2` maps every letter 13 positions ahead (wrapping past Z to A) -- applying this once to the ciphertext reverses the ROT13 and reveals the password.",
    ],
    "krypton-02": [
        "[Known-plaintext attack on Wikipedia](https://en.wikipedia.org/wiki/Known-plaintext_attack).",
    ...
    "krypton-04": [
        "[Vigenere cipher on Wikipedia](https://en.wikipedia.org/wiki/Vigen%C3%A8re_cipher).",
    ...
    "krypton-05": [
        "[Kasiski examination on Wikipedia](https://en.wikipedia.org/wiki/Kasiski_examination).",
