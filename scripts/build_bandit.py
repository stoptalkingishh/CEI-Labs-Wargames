...
CONNECT_NOTE = (
    "Launch your Bandit environment from this challenge (shared across all "
    "Bandit levels -- launching any one of them starts the same persistent "
    "box) and connect via SSH to the host/port CTFd shows you once it's "
    "ready."
)
...
challenges_data = [
    ...
    },
    {
        ...
        "points": 150,
        "desc": f"{CONNECT_NOTE} Log in as `bandit1` using the flag from the previous level as your password.\n\nFind the password for the next level hidden in the file named `-` (a single dash).",
    ...
    },
    {
        ...
        "points": 450,
        "desc": f"{CONNECT_NOTE} Log in as `bandit7` using the flag from the previous level as your password.\n\nThe password is in the file `data.txt` next to the word 'millionth'.",
    ...
    },
    {
        ...
        "points": 500,
        "desc": f"{CONNECT_NOTE} Log in as `bandit8` using the flag from the previous level as your password.\n\nThe password is in the file `data.txt`. It is the only line of text that occurs exactly once.",
    ...
    },
    {
        ...
        "points": 600,
        "desc": f"{CONNECT_NOTE} Log in as `bandit10` using the flag from the previous level as your password.\n\nThe password in `data.txt` is encoded. You will need to decode it from base64 format.",
    ...
    },
    {
        ...
        "points": 800,
        "desc": f"{CONNECT_NOTE} Log in as `bandit14` using the flag from the previous level as your password.\n\nThe password for the next level can be retrieved by submitting the password of the current level to **port 30000 on localhost**.",
    ...
    },
    {
        ...
        "points": 850,
        "desc": f"{CONNECT_NOTE} Log in as `bandit15` using the flag from the previous level as your password.\n\nThe password for the next level can be retrieved by submitting the password of the current level to **port 30001 on localhost** using SSL/TLS encryption.",
    ...
    },
    {
        ...
        "points": 900,
        "desc": f"{CONNECT_NOTE} Log in as `bandit16` using the flag from the previous level as your password.\n\nThe credentials for the next level can be retrieved by submitting the password of the current level to **a port on localhost in the range 31000 to 32000**.",
    ...
    },
    {
        ...
        "points": 1050,
        "desc": f"{CONNECT_NOTE} Log in as `bandit19` using the flag from the previous level as your password.\n\nTo gain access to the next level, you should use the setuid binary in the homedirectory.",
    ...
    },
    {
        ...
        "points": 1400,
        "desc": f"{CONNECT_NOTE} Log in as `bandit26` using the flag from the previous level as your password (this account's shell will page a short text file and exit -- try shrinking your terminal before you connect).\n\nNow that you broke out of the shell, query the directory layout to locate the flag.",
    ...
    },
    {
        ...
        "points": 1450,
        "desc": f"{CONNECT_NOTE}\n\nThere is a git repository at `ssh://bandit27-git@<your-instance-host>/home/bandit27-git/repo` (port matches your instance's SSH port) -- log in with bandit27's own password (the flag from the previous level). Clone the repository and find the password.",
    ...
    },
    {
        ...
        "points": 1500,
        "desc": f"{CONNECT_NOTE}\n\nThere is a git repository at `ssh://bandit28-git@<your-instance-host>/home/bandit28-git/repo` -- log in with bandit28's own password. Clone the repository and check its commit history.",
    ...
    },
    {
        ...
        "points": 1550,
        "desc": f"{CONNECT_NOTE}\n\nThere is a git repository at `ssh://bandit29-git@<your-instance-host>/home/bandit29-git/repo` -- log in with bandit29's own password. Clone the repository and investigate its branches.",
    ...
    },
    {
        ...
        "points": 1600,
        "desc": f"{CONNECT_NOTE}\n\nThere is a git repository at `ssh://bandit30-git@<your-instance-host>/home/bandit30-git/repo` -- log in with bandit30's own password. Clone the repository and look for git tags.",
    ...
    },
    {
        ...
        "points": 1650,
        "desc": f"{CONNECT_NOTE}\n\nThere is a git repository at `ssh://bandit31-git@<your-instance-host>/home/bandit31-git/repo` -- log in with bandit31's own password. Clone it, then push a file to retrieve the password (see the repository's README for the exact requirements).",
    ...
    },
    {
        ...
        "points": 1700,
        "desc": f"{CONNECT_NOTE} Log in as `bandit32` using the flag from the previous level as your password.\n\nThis account's login shell converts every command you type to UPPERCASE before running it. Find a way around that to reach a real shell, then locate the password for the next level.",
    ...
    },
    {
        ...
        "points": 1750,
        "desc": f"{CONNECT_NOTE} Log in as `bandit33` using the flag from the previous level as your password.\n\nAfter all this git stuff, it's time for another escape. Good luck!",
