...
challenges_data = [
    ...
    {"id": "sentinel-23", "name": "Sentinel 23: Detection Rule Validation", "points": 475,
     "goal": "Validate a fixed detection rule against a bounded committed local log corpus and interpret its decision record.",
...
HINTS = {
    ...
    "sentinel-23": ["Compare the fixed rule condition with each corpus record before using the decision record.", "The supplied rule and bounded log corpus are committed static evidence, not a prompt to run a live detection service.", "Read `detection-rule.yml`, `detection-corpus.log`, and `decision-record.txt`, then submit the rule_id, matches, and decision tuple through `sentinel-submit`."],
