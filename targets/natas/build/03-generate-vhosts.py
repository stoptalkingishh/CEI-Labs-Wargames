...
from natas_levels import LEVELS, port

WEBPASS = {0: "natas0"}
# levels 1-34 get an invalid, unguessable build-time placeholder --
...
for n in LEVELS:
    ...
    ports_lines.append(f"Listen {level_port}\n")

    vhost_conf = f"""<VirtualHost *:{level_port}>
...
print("Generated and enabled 35 Natas vhosts (ports 8000-8034).")
